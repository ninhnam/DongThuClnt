    ...
    <div class="header">
        <div class="header_wrap">
            ...
            <div class="search_header w-25">
                 <form  action="${pageContext.request.contextPath}/search_flower" method="post" class="search_header_wrap">
                     <input class="search_header_input" id="searchingFlower" name="searchingFlower" type="text"
                         placeholder="Nhập tên loại hoa">
    ...
    <div class="content">
        <div class="content_wrap">
            ...
            <div class="content_right">
            	<div class="content_right_add_container">
            		<div class="search_value_title"><strong>${deleteSuccess }</strong></div>
            		<div class="search_value_title"><strong>${editSuccess }</strong></div>
                    <a class="btn btn-success btn_add_success" href="add_flower"><strong>Thêm loại hoa</strong></a>
                </div>
