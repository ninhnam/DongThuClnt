    ...
    <div class="content">
        <div class="content_wrap">
            ...
            <div class="content_right">
				<h2 class="content_right_sum_title">Xác nhận xóa loại hoa</h2>
                <div class="right_list_form">
                    <img style="width: 500px;" src="${flower.getLink_image()}"
                        alt="">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td><strong>Loại hoa</strong></td>
                            <td>${flower.getFlowerstyle_name() }</td>
                        </tr>
                        <tr>
                    ...
                    <div class="btn_delete_confirm">
                        <a href="flower_delete_confirm?id=${flower.getId()}" type="button" class="btn btn-danger">Xác nhận xóa</a>
                    </div>
                </div>                
            </div>
        </div>
