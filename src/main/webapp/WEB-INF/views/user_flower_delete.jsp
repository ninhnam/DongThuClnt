    ...
    <div class="content">
        <div class="content_wrap">
            ...
            <div class="content_right">
                ...
                <h2 class="deleteUserTitle">Xác nhận xóa User</h2>
            </div>
                ...
                <a href="flower_user_delete_confirm?id=${userDel.getId()}" type="button"
                    class="btn btn-danger btn_delete_confirm_btn">Xác nhận xóa</a>
	            </div>
            </div>
            </div>
        </div>
