        ...
        <div class="content_wrap">
            ...
            <div class="content_right">
            	<div class="content_right_add_container">
            		<div class="search_value_title"><strong>Kết quả tìm kiếm cho: ${searchingFlower}</strong></div>
                    <div><a class="btn btn-success btn-add-flower-pink" href="add_flower"><strong>Thêm loại hoa</strong></a></div>
                </div>
