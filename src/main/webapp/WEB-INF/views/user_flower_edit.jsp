    ...
    <div class="content">
        <div class="content_wrap">
            ...
            <div class="content_right">
                ...
                <h2 class="deleteUserTitle">CHỈNH SỬA THÔNG TIN USER</h2>
            </div>
            
            <div class="right_list_form">
            <h3 class="add_product_success">${editUserSuccess }</h3>
                <form action="${pageContext.request.contextPath}/user_flower_edit" method="post">
                    <input hidden value="${userEdit.getId() }" type="text"  class="form-control"
                            name="id" id="id">
                    <input hidden value="${userEdit.getUsername() }" type="text" class="form-control"
                            name="username" id="username">
                    <div class="mb-3">
                        <label class="form-label"><strong>Username</strong></label>
                        <input disabled value="${userEdit.getUsername() }" minlength="4" required="" type="text" placeholder="Nhập Username" class="form-control"
                            name="username" id="username">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><strong>Password</strong></label>
                        <input minlength="6" value="${userEdit.getPassword() }"  required="" type="text" placeholder="Nhập Password" class="form-control"
